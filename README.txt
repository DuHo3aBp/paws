...
touch pcli.py и добавляем код
чтобы файл стал исполняемым добавляем в начало файла #!/usr/bin/env python3.8

также выполняем команду в консоле chmod +x pcli.py

добавляем в __init__.py переменную __version__ = "1.0"
теперь справочную информацию можно вывести так ./pcli.py --help

выполнить скачивание файла можно через команду 
./pcli.py download --bucket gdelt-open-data --key events/1979.csv --filename 1979.csv
